...
func (c Client) HasMinimumScopes(hostname string) error {
	apiEndpoint := common.RESTPrefix(hostname)
...
func (c Client) GraphQL(hostname string, query string, variables map[string]interface{}, data interface{}) error {
	...
	req, err := http.NewRequest("POST", common.GraphQLEndpoint(hostname), bytes.NewBuffer(reqBody))
	if err != nil {
		return err
	}
...
func graphQLClient(h *http.Client, hostname string) *graphql.Client {
	return graphql.NewClient(common.GraphQLEndpoint(hostname), h)
}

// REST performs a REST request and parses the response.
func (c Client) REST(hostname string, method string, p string, body io.Reader, data interface{}) error {
	url := common.RESTPrefix(hostname) + p
