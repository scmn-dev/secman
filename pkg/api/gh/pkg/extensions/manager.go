...
import (
	...
	"github.com/scmn-dev/secman/pkg/api/gh/pkg/extensions"
	"github.com/scmn-dev/secman/pkg/api/gh/pkg/findsh"
)
...
func (m *Manager) list(includeMetadata bool) []extensions.Extension {
	...
	for _, f := range entries {
		if !strings.HasPrefix(f.Name(), "sm-") || !(f.IsDir() || f.Mode()&os.ModeSymlink != 0) {
			continue
		}
